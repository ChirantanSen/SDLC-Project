...
//             <button
//               onClick={() => setActive("hiring")}
//               style={{
//                 padding: "8px 18px",
//                 borderRadius: "20px",
//                 border: active === "hiring" ? "2px solid #0b0b6b" : "1px solid #ccc",
//                 background: active === "hiring" ? "#fff" : "#fff",
//                 color: "#0b0b6b",
//                 cursor: "pointer",
//                 fontWeight: "bold",
//               }}
...
//                 borderRadius: "20px",
//                 border: "none",
//                 background: active === "work" ? "#0b0b6b" : "#0b0b6b",
//                 color: "#fff",
//                 cursor: "pointer",
//                 fontWeight: "bold",
//               }}
...
//                 {step.title}
//               </h3>
//               <p style={{ fontSize: "16px", color: "#555" }}>{step.description}</p>
//             </div>
//           ))}
//         </div>
//       </div>
      ...
      <section style={{ padding: "60px 20px", background: "#fff" }}>
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between" }}>
            ...
            >
              {/* <Link href="/auth/clientprofile/clientprofile" passHref>
  <button
    style={{
      padding: "8px 18px",
      borderRadius: "20px",
